...
export default class DynamicApprovalConfig extends LightningElement {
    ...
    async handleEdit(row) {
        ...
        this.configOnSubmitJson = row.On_Submit_JSON__c || this.getEmptyActionsJson();
    ...
    handleSubmitActionChange(event) {
        this.configOnSubmitJson = event.detail.actionJson;
    }
    ...
    async handleSave() {
        ...
        var config = {
            ...
            On_Submit_JSON__c: this.configOnSubmitJson,
    ...
    resetConfigForm() {
        ...
        this.configOnSubmitJson = this.getEmptyActionsJson();
