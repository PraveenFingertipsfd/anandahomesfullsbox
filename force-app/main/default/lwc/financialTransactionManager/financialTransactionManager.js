...
export default class FinancialTransactionManager extends NavigationMixin(LightningElement) {
    ...
    get formattedMaxRefund() {
        const maxRefund = this.bookingSummary.maxRefundableAmount || 0;
    ...
    validateRefundForm() {
        ...
        if (this.refundAmount > maxRefund) {
            errors.push(`Refund amount cannot exceed the maximum refundable amount of ${this.formatCurrency(maxRefund)}`);
        }
