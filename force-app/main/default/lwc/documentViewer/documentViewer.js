...
export default class DocumentViewer extends NavigationMixin(LightningElement) {
    ...
    @track previewUrl = '';        // HTML render shown in the iframe (matches the designer preview)
    @track previewPdfUrl = '';     // PDF URL for the download button in the preview panel
    ...
    // ---- Word format (#1): view in a new tab and download ----
    ...
    // ---- Send Email (#2): open the email composer with this document pinned ----
